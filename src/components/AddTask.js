  ...
  return (
    <>
        ...
        <TextField id='taskName-input' label= 'Enter task name' required aria-placeholder='Enter name' aria-required
            ...
            <FormControlLabel  control={<Checkbox id='reminderCheck' aria-details='Reminder checkbox'/>} label='Reminder'
                    value={reminder} onClick={(e)=>
                    setReminder(e.target.checked)}>
            </FormControlLabel>
            <FormControlLabel  control={<Checkbox id='priorityCheck' aria-details='Priority checkbox'/>} label='Priority'
